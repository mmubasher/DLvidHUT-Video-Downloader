...
if(!empty($matches[1])){
    echo '<br>
<a href="https://dlhut.ml/dl/aio/3gp.php/?title='.$title.'&vkr=https://www.youtube.com/watch?v='.$matches[1].'"><button style="width:100%;"  class="btn btn-success"> Download  3GP </button></a><br>';
} 
else echo '';
if(!empty($vod)){
    echo '<br>
