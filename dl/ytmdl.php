...
<video poster="<?php echo $thumbux; ?>" width="100%" height="340" controls>
 <source src="https://dlhut.000webhostapp.com/stream.php?vkr=<?php echo $lloc; ?>" type="video/mp4">
...
if(!empty($title)){
    echo '<iframe style="width:96%; height:55px; border:0px;" scrolling="no" src="https://dlhut.000webhostapp.com/dl/btn.php/?f=mp3&vkr=https://youtu.be/'.$matches[1].'"></iframe><br>';
}
else echo ''; 


if(!empty($m4a)){
    echo '<iframe style="width:96%; height:55px; border:0px;" scrolling="no" src="https://dlhut.000webhostapp.com/dl/btn.php/?f=m4a&vkr=https://youtu.be/'.$matches[1].'">
</iframe><br>';
}
else echo ''; 

 if(!empty($matches[1])){
    echo '<iframe style="width:96%; height:55px; border:0px;" scrolling="no" src="https://dlhut.000webhostapp.com/dl/btn.php/?f=webm&vkr=https://youtu.be/'.$matches[1].'">
</iframe><br>';
}
else echo ''; 
 if(!empty($matches[1])){
    echo '<iframe style="width:96%; height:55px; border:0px;" scrolling="no" src="https://dlhut.000webhostapp.com/dl/btn.php/?f=wav&vkr=https://youtu.be/'.$matches[1].'">
</iframe><br>';
}
else echo ''; 
?>
